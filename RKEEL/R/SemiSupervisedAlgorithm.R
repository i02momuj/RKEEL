#Class implementing the SemiSupervised Learning Algorithm
  #Implements the common functions of a KEEL SemiSupervised algorithm

SemiSupervisedAlgorithm <- R6::R6Class("SemiSupervisedAlgorithm",
  ...
  public = list(
    ...
    run = function(){
      ...
      tryCatch({
        ...
        #Write dataset files
        writeDatFromDataframes(private$trainDataset, private$trsDataset, private$testDataset, paste0(private$mainPath, "/datasets/", private$dataName, "/", private$trainFilename), paste0(private$mainPath, "/datasets/", private$dataName, "/", private$trsFilename), paste0(private$mainPath, "/datasets/", private$dataName, "/", private$testFilename))
        ...
        unlink(paste0(private$dataPath, private$trsFilename))
  ...
  private = list(
    ...
    writeKeelConfig = function(){
      ...
      #Ficheros de entrada
      inputDataString = paste0("\"../datasets/", private$dataName, "/", private$trainFilename, "\" \"../datasets/", private$dataName, "/", private$trsFilename, "\" \"../datasets/", private$dataName, "/", private$testFilename, "\"")
      #Ficheros de salida
